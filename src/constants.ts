...
export const GRID_X_LABELS = [0, 200, 400, 600, 800, MODEL_COORDINATE_MAX];
export const GRID_Y_LABELS = [0, 200, 400, 600, 800, MODEL_COORDINATE_MAX];
export const MAX_COLLABORATION_PASSES = 10;
export const DEFAULT_MAX_COMPLETION_TOKENS = 5000;
